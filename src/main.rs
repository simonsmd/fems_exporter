...
const MODBUS_METRICS: [(&str, u16, ModbusType); 33] = [
    ("state", 222, U16),
    ("ess_soc", 302, U16),
    ("ess_active_power", 303, F32),
    ("ess_reactive_power", 309, F32),
    ("grid_active_power", 315, F32),
    ("production_active_power", 327, F32),
    ("production_ac_active_power", 331, F32),
    ("production_dc_actual_power", 339, F32),
    ("consumption_active_power", 343, F32),
    ("ess_active_charge_energy", 351, F64),
    ("ess_active_discharge_energy", 355, F64),
    ("grid_buy_active_energy", 359, F64),
    ("grid_sell_active_energy", 363, F64),
    ("production_active_energy", 367, F64),
    ("production_ac_active_energy", 371, F64),
    ("production_dc_active_energy", 375, F64),
    ("consumption_active_energy", 379, F64),
    ("ess_dc_charge_energy", 383, F64),
    ("ess_dc_discharge_energy", 387, F64),
    ("ess_active_power_l1", 391, F32),
    ("ess_active_power_l2", 393, F32),
    ("ess_active_power_l3", 395, F32),
    ("grid_active_power_l1", 397, F32),
    ("grid_active_power_l2", 399, F32),
    ("grid_active_power_l3", 401, F32),
    ("production_ac_active_power_l1", 403, F32),
    ("production_ac_active_power_l2", 405, F32),
    ("production_ac_active_power_l3", 407, F32),
    ("consumption_ac_active_power_l1", 409, F32),
    ("consumption_ac_active_power_l2", 411, F32),
    ("consumption_ac_active_power_l3", 413, F32),
    ("ess_discharge_power", 415, F32),
    ("grid_mode", 417, U16),
];
